...
std::string GameState::toString(int pPlayer) const
{
	...
	ss << "  4 " << board_left; for(int c=0;c<4;++c) ss << cell_text[at(1,c,0)]; ss << board_right << " 7  " << " 20 " << board_left; for(int c=0;c<4;++c) ss << cell_text[at(1,c,1)]; ss << board_right << " 23 " << " 36 " << board_left; for(int c=0;c<4;++c) ss << cell_text[at(1,c,2)]; ss << board_right << " 39 " << " 52 " << board_left; for(int c=0;c<4;++c) ss << cell_text[at(1,c,3)]; ss << board_right << " 55  current player: " + cell_text[mNextPlayer] + (is_my_turn ? " (My turn)\n" : " (Opponents turn)\n");
